...
public class SamePackageSubClass extends SourceClass {
    public SamePackageSubClass(int id, String name, String address, float gpa, String city) {
        super(id, name, address, gpa, city);
    }

    public static void main(String[] args) {
        SamePackageSubClass sc = new SamePackageSubClass(1, "Gaurav", "HYD,IND", 8.56f, "HYD");
